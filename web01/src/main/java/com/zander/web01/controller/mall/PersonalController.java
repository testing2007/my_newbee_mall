...
import com.zander.web01.util.Result;
import com.zander.web01.util.ResultGenerator;
...
public class PersonalController {
    ...
    public Result login(@RequestParam("loginName") String loginName,
        ...
        System.out.printf("loginName=%s, verifyCode=%s, password=%s", loginName, verifyCode, password);
        ...
        System.out.print("kaptchaCode 1111\n");
        String kaptchaCode = httpSession.getAttribute(Constants.MALL_VERIFY_CODE_KEY) + "";
        System.out.printf("kaptchaCode=%s\n", kaptchaCode);
        ...
        System.out.printf("loginResult=%s\n", loginResult);
        //登录成功
